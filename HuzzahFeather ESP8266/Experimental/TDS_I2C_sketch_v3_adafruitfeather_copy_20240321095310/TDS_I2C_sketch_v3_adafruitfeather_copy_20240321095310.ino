...
float Multiplier = .0361328125;  // This is with the voltage reduction on the circuit (calculated from readings taken from the ADC pin, with and without reducer in place)
...
void loop() {
    ...
    //sensorValue = sensorValue/Multiplier; // Upscale the reported value to compensate for the voltage reduction
    //Serial.print("Reported Adjusted Value = ");
    //Serial.println(sensorValue);        // Print voltage to serial monitor
